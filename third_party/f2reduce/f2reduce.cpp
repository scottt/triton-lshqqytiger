...
static void chunked_kronrod(const uint64_t *RESTRICT pivots,
                            uint64_t *RESTRICT matrix, uint64_t rows,
                            uint64_t strips, uint64_t stride,
                            const uint64_t *workspace, uint64_t *RESTRICT cache,
                            int k) {
...
static bool perform_K_steps(uint64_t *RESTRICT matrix,
                            ...
                            uint64_t strips, uint64_t stride,
                            uint64_t &starting_row, uint64_t *workspace,
                            uint64_t *RESTRICT cache, uint64_t &next_b, int K,
                            uint64_t final_b) {
...
static void inplace_rref_strided_K(uint64_t *RESTRICT matrix,
                                   ...
                                   uint64_t *workspace, uint64_t *cache,
                                   int K) {
